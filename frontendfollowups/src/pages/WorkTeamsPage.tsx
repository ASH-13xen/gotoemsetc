...
// leader who otherwise couldn't see their own team here. Only the mutating
// controls below (New Team / Edit / Delete) are canManageTasks-gated.
            ...
            {teams.map((team) => (
              <Card key={team._id} className="p-6">
                ...
                <CardContent className="space-y-2 px-0">
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Leader</p>
