...
router.post('/', requireRole(USER_ROLES.ADMIN), validate(holidayValidator.create), holidayController.create);
router.delete('/:id', requireRole(USER_ROLES.ADMIN), validate(holidayValidator.remove), holidayController.remove);
