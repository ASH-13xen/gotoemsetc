...
// admin just has to hit send from their own logged-in account. No SMTP, no
// WhatsApp Business API, nothing that needs approval or can go down.

// The recruitment/employee forms only collect a bare 10-digit Indian mobile
// number (no country code prompt) — same assumption the backend WhatsApp
// integration made, kept here for consistency.
